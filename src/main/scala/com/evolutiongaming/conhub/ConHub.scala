...
object ConHub {
  ...
  trait Send[A, M] extends ConnTypes[A, M] {
    ...
    /**
     * @param msg
     *   message will be delivered to all matched connections whether it is Local or Remote
     *   connection
     * @return
    ...
    /**
     * @param msgs
     *   messages will be delivered to all matched connections whether it is Local or Remote
     *   connection
     * @return
     *   list of local connections that matched the message
     */
